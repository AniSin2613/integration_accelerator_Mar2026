...
const demoTemplates: TemplatesPageData['templates'] = [
  // ── Demo-first templates (the primary entry points for hands-on testing) ──
  {
    id: 'tpl_coupa_invoice_json_demo',
    name: 'Coupa Invoice → JSON',
    group: 'Prebuilt',
    categoryLabel: 'Prebuilt Template',
    templateTypeTag: 'Demo Accelerator',
    description: 'Fetch approved invoices from Coupa and send to the internal JSON demo receiver. Select your Coupa connection and run an instant end-to-end test.',
    source: 'Coupa',
    target: 'Demo JSON',
    useCase: 'Invoices',
    objectType: 'Invoice',
  ...
  },
  {
    ...
    categoryLabel: 'Prebuilt Template',
    templateTypeTag: 'Demo Accelerator',
    description: 'Fetch approved invoices from Coupa and send as XML to the internal demo receiver. Tests XML serialization end-to-end without external target setup.',
    source: 'Coupa',
    target: 'Demo XML',
    useCase: 'Invoices',
    objectType: 'Invoice',
  ...
  // ── Certified business accelerators ──────────────────────────────────────
  {
