    ...
    <div className="bg-background-light font-display min-h-screen text-text-main flex flex-col">
      ...
      <header className="flex items-center justify-between border-b border-border-soft bg-surface px-6 lg:px-10 py-4">
        <Link href="/" className="flex items-center gap-3 text-text-main">
          ...
          <span className="text-[17px] font-bold tracking-tight">Cogniviti Bridge</span>
        </Link>
        <Link
          href="/login"
        ...
        <div className="mt-8 space-y-6">
          ...
          {submitted ? (
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="name" className="block text-[13px] font-medium text-text-main mb-1">
                    Name
                  </label>
                  <input
                    id="name"
                ...
                <div>
                  <label htmlFor="email" className="block text-[13px] font-medium text-text-main mb-1">
                    Email
                  </label>
                  <input
                    id="email"
